...
function init_platform()
    ...
    after_load(function (target)
        ...
        -- target:add( "defines", "ARC_PLATFORM_" .. string.upper( config.plat() ) )
        target:add( "defines", "ARC_ARCH_"     .. string.upper( config.arch() ) )
        target:add( "defines", "ARC_"          .. string.upper( config.mode() ) )
