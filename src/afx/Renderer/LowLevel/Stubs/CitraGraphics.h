...
class CitraGraphics : public Registar<CitraGraphics, ILowLevelGraphics>
{
public:
	static std::string getName() { return "Citra"; }
	static ILowLevelGraphics* allocate( void* _pUserData ) { return new CitraGraphics(); }

	// Inherited via Registar
