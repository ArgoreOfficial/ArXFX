...
///////////////////////////////////////////////////////////////////////////////////////
	...
	Vector4( const _Ty& _t ) : x{ _t }, y{ _t }, z{ _t }, w{ _t } { }
	Vector4( const _Ty& _x, const _Ty& _y, const _Ty& _z, const _Ty& _w ) : x{ _x }, y{ _y }, z{ _z }, w{ _w } { }


	_Ty length( void )                      const { return std::sqrt( x * x + y * y + z * z + w * w ); }
	_Ty dot( const Vector4<_Ty>& _other ) const { return x * _other.x + y * _other.y + z * _other.z + w * _other.w; }
