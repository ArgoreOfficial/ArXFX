...
///////////////////////////////////////////////////////////////////////////////////////
	...
	Vector3( const _Ty& _t ) : x( _t ), y( _t ), z( _t ) { }
	Vector3( const _Ty& _x, const _Ty& _y, const _Ty& _z ) : x( _x ), y( _y ), z( _z ) { }

	_Ty length( void )                      const { return std::sqrt( x * x + y * y + z * z ); }
	_Ty dot( const Vector3<_Ty>& _other ) const { return x * _other.x + y * _other.y + z * _other.z; }
